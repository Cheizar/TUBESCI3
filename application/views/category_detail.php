...
<html lang="en">
  ...
  <body>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="../../welcome">Data Barang</a>
            </li>
    ...
    <!-- Page Header -->
    <header class="masthead" style="background-image: url('assets/img/barang.jpg')">
        ...
        <div class="row">
          <div class="col-lg-8 col-md-10 mx-auto">
            <div class="site-heading">
              ...
              <span class="subheading">Barang Elektronik</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <table>
          <tr class="text-center">
            <td>
              <h3><b><?php echo $key->nama_barang; ?></b><h3>
              </td>
          </tr>
          <tr>
